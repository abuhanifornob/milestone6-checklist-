...
const oneParameter = (number) => number / 17;
console.log(oneParameter(100));
...
const twoParameter = (number1, number2) => (number1 + number2) / 2;
console.log(twoParameter(10, 30));
...
const sumArraow = (number1, number2) => {
    number1 += 7;
    number2 += 7;
    return number1 + number2;
}

console.log(sumArraow(10, 10));